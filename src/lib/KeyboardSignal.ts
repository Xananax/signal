...
import {SKIP,createSignal,createCombinedObjectSignal} from '../';
...
export function KeyboardSignal(keyCodes:number[],name?:string,now:SignalTimeProvider=Date.now):ToggleSignal{
